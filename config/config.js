...
var initGlobalConfig = function () {
    ...
    var environmentAssets = require(path.join(process.cwd(), 'config/env/', process.env.NODE_ENV)) || {};

    // Merge assets
    var assets = _.merge(defaultAssets, environmentAssets);

    // Get the default config
    var defaultConfig = require(path.join(process.cwd(), 'config/assets/default'));
